      ...
      <div class="bg-secondary h-full pb-14 pt-8">
        ...
        <div class="">
          <NuxtLink
            ...
            class="flex items-center p-3 h-1/3 hover:bg-primary-default/25"
            :to="article._path"
          >
            <div
          ...
          380"
            ...
            <div
              class="w-1/2 md:w-2/3 h-full flex flex-col p-2 items-center gap-4 z-0 -translate-x-2 lg:-translate-x-6"
            >
