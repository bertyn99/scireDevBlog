  ...
  <div class="absolute flex h-full w-full">
    ...
    <div class="h-[475px] w-full  relative sm:h-full group">
      ...
      <NuxtLink
        ...
        :to="data._path"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
          stroke="currentColor" class="w-5 h-5">
          <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 4.5l15 15m0 0V8.25m0 11.25H8.25" />
        </svg>
        <span class="capitalize ">Read More</span>
      </NuxtLink>
      <div class="sm:hidden absolute w-full h-full bg-secondary/60 z-20 text-white pt-6 pb-2">
        <div class="w-[90%] mx-auto min-w-[190px]">
          <div class="mt-8">
            <div class="flex items-center">
              <div class="relative overflow-hidden rounded-full h-8 w-8">
                <img :src="getAuthorImg(data.author)" :alt="`image de profile ${data.author}`"
          ...
          <div class="flex gap-8 px-2">
            <span class="inline-flex items-center gap-1 text-sm text-primary-default"><svg
